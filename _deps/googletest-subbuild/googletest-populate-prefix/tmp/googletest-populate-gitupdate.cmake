...
execute_process(
  COMMAND "/usr/bin/git" show-ref "25808659d317cb03409e7949914b274e10e6824f"
  WORKING_DIRECTORY "/home/pi/profinet/p-net/_deps/googletest-src"
...
if("${show_ref_output}" MATCHES "refs/remotes/25808659d317cb03409e7949914b274e10e6824f")
  string(REGEX MATCH "^([^/]+)/(.+)$" _unused "25808659d317cb03409e7949914b274e10e6824f")
  set(git_remote "${CMAKE_MATCH_1}")
  set(git_tag "${CMAKE_MATCH_2}")
else()
  set(git_remote "origin")
  set(git_tag "25808659d317cb03409e7949914b274e10e6824f")
endif()
...
if(error_code OR is_remote_ref OR NOT ("${tag_sha}" STREQUAL "${head_sha}"))
  ...
  if(error_code)
    message(FATAL_ERROR "Failed to fetch repository 'https://github.com/rtlabs-com/googletest.git'")
  endif()
    ...
    if("REBASE" STREQUAL "CHECKOUT")
      ...
      if(error_code)
        ...
        if(NOT "REBASE" STREQUAL "REBASE_CHECKOUT")
          ...
          message(FATAL_ERROR "\nFailed to rebase in: '/home/pi/profinet/p-net/_deps/googletest-src'."
    ...
    if(need_stash)
      ...
      if(error_code)
        ...
        if(error_code)
          ...
          message(FATAL_ERROR "\nFailed to unstash changes in: '/home/pi/profinet/p-net/_deps/googletest-src'."
                              "\nYou will have to resolve the conflicts manually")
        endif()
      endif()
    endif()
