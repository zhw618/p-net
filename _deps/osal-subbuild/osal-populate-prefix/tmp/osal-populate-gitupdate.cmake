...
execute_process(
  COMMAND "/usr/bin/git" show-ref "88784fc"
  WORKING_DIRECTORY "/home/pi/profinet/p-net/_deps/osal-src"
...
if("${show_ref_output}" MATCHES "refs/remotes/88784fc")
  string(REGEX MATCH "^([^/]+)/(.+)$" _unused "88784fc")
...
if(error_code OR is_remote_ref OR NOT ("${tag_sha}" STREQUAL "${head_sha}"))
  ...
  if(error_code)
    message(FATAL_ERROR "Failed to fetch repository 'https://github.com/rtlabs-com/osal.git'")
  endif()
    ...
    if("REBASE" STREQUAL "CHECKOUT")
      ...
      if(error_code)
        ...
        if(NOT "REBASE" STREQUAL "REBASE_CHECKOUT")
          ...
          message(FATAL_ERROR "\nFailed to rebase in: '/home/pi/profinet/p-net/_deps/osal-src'."
    ...
    if(need_stash)
      ...
      if(error_code)
        ...
        if(error_code)
          ...
          message(FATAL_ERROR "\nFailed to unstash changes in: '/home/pi/profinet/p-net/_deps/osal-src'."
                              "\nYou will have to resolve the conflicts manually")
        endif()
      endif()
    endif()
